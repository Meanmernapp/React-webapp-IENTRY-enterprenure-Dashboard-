...
import { CreateToExternal, DownloadCompanyFile, DownloadExternalFile, GetUserDocuments, SetToExternal } from '../../reduxToolkit/Providers/providersApi';
...
const UserDocuments = () => {
    ...
    const { getUserDocuments } = useSelector(state => state?.providersSlice)
    ...
    useEffect(() => {
        dispatch(GetUserDocuments(getProvidersByUserId?.user?.id))
        ...
        <div className='user_document_conatiner'>
          ...
          <span>{item?.document}</span>
                        ...
                        <div className="mt-4">
                            ...
                            <NotFoundDataWarning text={"No Data"} />
                        </div>
                }
            </div>
        </div>
