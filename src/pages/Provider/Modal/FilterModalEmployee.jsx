...
import { GetProvidersEmployeeSortList } from "../../../reduxToolkit/Providers/providersApi";
...
const FilterModal = ({ setShowFilter, handlFilters }) => {
    ...
    const { getProvidersEmployeeSortList } = useSelector(state => state?.providersSlice)
    console.log(getProvidersEmployeeSortList)

    useEffect(() => {
        handlFilters(orderby, sort);
        // orderByApi();
        dispatch(GetProvidersEmployeeSortList())
    }, [orderby, sort])
                ...
                <div className="col-md-12 filter_body">
                    ...
                    >
                        <FormControl fullWidth sx={{
                            ...
                            >
                                {
                                    getProvidersEmployeeSortList?.map(value => (
