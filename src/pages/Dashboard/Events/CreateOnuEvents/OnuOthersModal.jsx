    ...
    const handleConfirm = () => {
        if (readOnly === true) {
            ...
            if (preRegisterObj?.name && preRegisterObj.email && preRegisterObj.phoneNumber) {
                ...
                console.log(preRegisterObj?.name, preRegisterObj.email, preRegisterObj.phoneNumber)
                toast.warn("Please Find user or Field info")
            }
        ...
        >
            ...
            <Modal.Body className="manage_others_modal_body">
                ...
                </div>
                {
                    ...
                    <p className='bottomText text-center mt-2'><span>USER NOT FUNDED? </span> please pre-register the user</p>
                }
                ...
                <div className="buttonArea mt-4 d-flex">
                    <button
                        style={{ width: "180px" }}
                        className="custom_btn_cancel_gray_hover" onClick={() => {
                            props.onHide()
                            setErrorNumber("")
                            setErrorEmail("")
                            setOthersExtraData({
